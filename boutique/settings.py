...
SECRET_KEY = 'django-insecure-qnx&-&^z#bobidly@nc2!e+fh-lk+ii*brmn0%nvkn_amz1(fl'
...
#Variable para que django permita mostrar alertas
...
INSTALLED_APPS = [
    ...
    'app',
    'colorfield',
    #filtro para que el precio se muestre en miles 
