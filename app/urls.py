...
from .views import home,listar,agregar_producto,modificar,eliminar,marca,lista_mensajes,eliminar_mensaje,ver_mensaje,registro,inicioAdmin
...
urlpatterns = [
    ...
    path('InicioAdimin/', inicioAdmin,name="administrador"),
